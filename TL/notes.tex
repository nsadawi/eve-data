...
\begin{figure}[htp]
  \begin{center}
    \subfigure[TL Algo]{\label{fig:a1}\includegraphics[scale=0.4]{figs/exp1-10CV}}\\
    \subfigure[NB Algo]{\label{fig:b1}\includegraphics[scale=0.4]{figs/exp1-NB-10CV}} \\
    \subfigure[SVM Algo]{\label{fig:c1}\includegraphics[scale=0.4]{figs/exp1-SVM-10CV}}\\
    \subfigure[J48 Algo]{\label{fig:d1}\includegraphics[scale=0.4]{figs/exp1-J48-10CV}}
  \end{center}
...
\begin{figure}[htp]
  \begin{center}
    \subfigure[TL Algo]{\label{fig:a2}\includegraphics[scale=0.4]{figs/exp2-10CV}}\\
    \subfigure[NB Algo]{\label{fig:b2}\includegraphics[scale=0.4]{figs/exp2-NB-10CV}} \\
    \subfigure[SVM Algo]{\label{fig:c2}\includegraphics[scale=0.4]{figs/exp2-SVM-10CV}}\\
    \subfigure[J48 Algo]{\label{fig:d2}\includegraphics[scale=0.4]{figs/exp2-J48-10CV}}
  \end{center}
  \caption{Stats after running 10 Fold CV}
  \label{fig:stats2}
\end{figure}
